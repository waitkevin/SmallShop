...
class CreateSystemNodesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('system_nodes', function (Blueprint $table) {
            ...
            $table->string('icons', 150)->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci')->comment('权限图标');
            ...
            $table->string('path', 255)->nullable()->charset('utf8mb4')->collation('utf8mb4_unicode_ci')->comment('权限路径');
            $table->nestedSet();
